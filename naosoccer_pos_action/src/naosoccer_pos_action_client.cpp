...
void NaosoccerPosActionNode::goal_response_callback(
...
void NaosoccerPosActionNode::feedback_callback(
...
void NaosoccerPosActionNode::result_callback(
  const ClientGoalHandlePosAction::WrappedResult & result)
{
  switch (result.code) {
